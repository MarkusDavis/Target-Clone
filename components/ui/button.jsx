...
const buttonVariants = cva(
  " inline-flex items-center justify-center whitespace-nowrap rounded-sm text-sm font-medium ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:ring-offset-red-950 dark:focus-visible:ring-red-300",
  {
    variants: {
      variant: {
        default:
          "bg-target text-white hover:bg-red-900/90 dark:bg-gray-50 dark:text-gray-900 dark:hover:bg-gray-50/90",
        destructive:
          "bg-red-500 text-gray-50 hover:bg-red-800 dark:bg-red-900 dark:text-gray-50 dark:hover:bg-red-800/90",
        outline:
